...
static
void __attribute__((section(".upper.text"))) mem_cpy (void* dst, const void* src, UINT cnt) {
	BYTE *d = (BYTE*)dst;
...
/* Fill memory */
static
void __attribute__((section(".upper.text"))) mem_set (void* dst, int val, UINT cnt) {
	BYTE *d = (BYTE*)dst;
...
static
int __attribute__((section(".upper.text"))) mem_cmp (const void* dst, const void* src, UINT cnt) {
...
static
int __attribute__((section(".upper.text"))) chk_chr (const char* str, int chr) {
...
#if !_FS_READONLY
static
FRESULT __attribute__((section(".upper.text"))) sync_window (
	FATFS* fs		/* File system object */
)
{
	DWORD wsect;
...
static
FRESULT __attribute__((section(".upper.text"))) move_window (
	FATFS* fs,		/* File system object */
...
#if !_FS_READONLY
static
FRESULT __attribute__((section(".upper.text"))) sync_fs (	/* FR_OK: successful, FR_DISK_ERR: failed */
	FATFS* fs		/* File system object */
)
{
	FRESULT res;
...
DWORD __attribute__((section(".upper.text"))) clust2sect (	/* !=0: Sector number, 0: Failed - invalid cluster# */
	FATFS* fs,		/* File system object */
...
DWORD __attribute__((section(".upper.text"))) get_fat (	/* 0xFFFFFFFF:Disk error, 1:Internal error, Else:Cluster status */
	FATFS* fs,	/* File system object */
...
FRESULT __attribute__((section(".upper.text"))) put_fat (
	FATFS* fs,	/* File system object */
...
#if !_FS_READONLY
static
FRESULT __attribute__((section(".upper.text"))) remove_chain (
	FATFS* fs,			/* File system object */
...
#if !_FS_READONLY
static
DWORD __attribute__((section(".upper.text"))) create_chain (	/* 0:No free cluster, 1:Internal error, 0xFFFFFFFF:Disk error, >=2:New cluster# */
	FATFS* fs,			/* File system object */
...
#if _USE_FASTSEEK
static
DWORD __attribute__((section(".upper.text"))) clmt_clust (	/* <2:Error, >=2:Cluster number */
...
static
FRESULT __attribute__((section(".upper.text"))) dir_sdi (
...
static
FRESULT __attribute__((section(".upper.text"))) dir_next (	/* FR_OK:Succeeded, FR_NO_FILE:End of table, FR_DENIED:Could not stretch */
...
#if !_FS_READONLY
static
FRESULT __attribute__((section(".upper.text"))) dir_alloc (
	DIR* dp,	/* Pointer to the directory object */
...
static
DWORD __attribute__((section(".upper.text"))) ld_clust (
...
static
FRESULT __attribute__((section(".upper.text"))) dir_find (
...
static
FRESULT __attribute__((section(".upper.text"))) dir_read (
	DIR* dp,		/* Pointer to the directory object */
...
#if !_FS_READONLY
static
FRESULT __attribute__((section(".upper.text"))) dir_register (	/* FR_OK:Successful, FR_DENIED:No free entry or too many SFN collision, FR_DISK_ERR:Disk error */
...
static
void __attribute__((section(".upper.text"))) get_fileinfo (		/* No return code */
	DIR* dp,			/* Pointer to the directory object */
...
static
FRESULT __attribute__((section(".upper.text"))) create_name (
	DIR* dp,			/* Pointer to the directory object */
...
static
FRESULT __attribute__((section(".upper.text"))) follow_path (	/* FR_OK(0): successful, !=0: error code */
...
static
int __attribute__((section(".upper.text"))) get_ldnumber (		/* Returns logical drive number (-1:invalid drive) */
...
static
BYTE __attribute__((section(".upper.text"))) check_fs (	/* 0:FAT boor sector, 1:Valid boor sector but not FAT, 2:Not a boot sector, 3:Disk error */
	FATFS* fs,	/* File system object */
...
//static FRESULT __attribute__ ((section (".upper.text"))) find_volume (	/* FR_OK(0): successful, !=0: any error occurred */
static FRESULT __attribute__((section(".upper.text"))) find_volume (	/* FR_OK(0): successful, !=0: any error occurred */
...
static
FRESULT __attribute__((section(".upper.text"))) validate (	/* FR_OK(0): The object is valid, !=0: Invalid */
...
FRESULT __attribute__((section(".upper.text"))) f_mount (
...
FRESULT __attribute__((section(".upper.text"))) f_read (
	FIL* fp, 		/* Pointer to the file object */
...
FRESULT __attribute__((section(".upper.text"))) f_write (
	FIL* fp,			/* Pointer to the file object */
...
FRESULT __attribute__((section(".upper.text"))) f_sync (
	FIL* fp		/* Pointer to the file object */
)
{
	FRESULT res;
...
FRESULT __attribute__((section(".upper.text"))) f_close (
...
FRESULT __attribute__((section(".upper.text"))) f_lseek (
	FIL* fp,		/* Pointer to the file object */
...
FRESULT __attribute__((section(".upper.text"))) f_opendir (
...
FRESULT __attribute__((section(".upper.text"))) f_closedir (
...
FRESULT __attribute__((section(".upper.text"))) f_readdir (
